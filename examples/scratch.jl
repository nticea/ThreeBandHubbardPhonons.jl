...
# DMRG parameters 
DMRG_numsweeps = 3 # total number of iterations 
...
start, stop, dSC_dxdx = @time compute_equilibrium_pairfield_correlation(dmrg_results, HM, p, "dx-dx", "dx-dx", "dSC", memory_saver=false)
start, stop, dSC_dxdx = @time compute_equilibrium_pairfield_correlation(dmrg_results, HM, p, "dx-dx", "dx-dx", "dSC", memory_saver=true)
