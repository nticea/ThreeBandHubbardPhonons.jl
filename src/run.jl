...
function correlations_run_checkpoint(Nx, Ny, yperiodic,
    ...
    println("Computing dSC_dxdx correlation")
    flush(stdout)
    ...
    println("Computing spin correlation")
    flush(stdout)
    ...
    println("Computing charge correlation")
    flush(stdout)
    ...
    println("Computing particle correlation")
    flush(stdout)
    ...
    println("Computing sSC correlation")
    flush(stdout)
    ...
    println("Computing pSC_dxdx correlation")
    flush(stdout)
    @time compute_equilibrium_pairfield_correlation_checkpoint(eq_corr, dmrg_results, HM, p, "pSC_dxdx", "dx-dx", "dx-dx", "pSC", results_save_path)
    println("Completed pSC_dxdx correlation")
    flush(stdout)

    println("Computing dSC_dpx correlation")
    flush(stdout)
    @time compute_equilibrium_pairfield_correlation_checkpoint(eq_corr, dmrg_results, HM, p, "dSC_dpx", "d-px", "d-px", "dSC", results_save_path)
    println("Completed dSC_dpx correlation")
    flush(stdout)

    println("Computing dSC_pyd correlation")
    flush(stdout)
    @time compute_equilibrium_pairfield_correlation_checkpoint(eq_corr, dmrg_results, HM, p, "dSC_pyd", "py-d", "py-d", "dSC", results_save_path)
    println("Completed dSC_pyd correlation")
    flush(stdout)

    println("Computing dSC_pypx correlation")
    flush(stdout)
    @time compute_equilibrium_pairfield_correlation_checkpoint(eq_corr, dmrg_results, HM, p, "dSC_pypx", "py-px", "py-px", "dSC", results_save_path)
    println("Completed dSC_pypx correlation")
    flush(stdout)

    if p.Ny > 1
        println("Computing dSC_py1px2 correlation")
        flush(stdout)
        @time compute_equilibrium_pairfield_correlation_checkpoint(eq_corr, dmrg_results, HM, p, "dSC_py1px2", "py1-px2", "py1-px2", "dSC", results_save_path)
        println("Completed dSC_py1px2 correlation")
        flush(stdout)

        println("Computing dSC_dydy correlation")
        flush(stdout)
        @time compute_equilibrium_pairfield_correlation_checkpoint(eq_corr, dmrg_results, HM, p, "dSC_dydy", "dy-dy", "dy-dy", "dSC", results_save_path)
